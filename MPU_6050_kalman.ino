...
void loop() {
  ...
  //KalmanAngleRoll = 0.991*(KalmanAngleRoll+RateRoll*0.004) + (1-0.991)*AngleRoll;
  //KalmanAnglePitch = 0.991*(KalmanAnglePitch+RatePitch*0.004) + (1-0.991)*AnglePitch;
 ...
 // Serial.print(" Pitch Angle [°] ");
  ...
  Serial.print(" ");
  //Serial.print(" Pitch Angle kalman [°] ");
