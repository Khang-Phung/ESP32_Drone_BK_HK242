...
float AccYCalibration, AccZCalibration;
...
void loop() {
  ...
  if (commandValue != 1) {
    ...
    */
    ...
    Input_motor1 = constrain(Input_motor1, 1000, 2000);
    Input_motor2 = constrain(Input_motor2, 1000, 2000);
    Input_motor3 = constrain(Input_motor3, 1000, 2000);
    Input_motor4 = constrain(Input_motor4, 1000, 2000);
